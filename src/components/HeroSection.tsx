  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Kontainer Utama Flex: Berubah jadi baris pada layar medium ke atas */}
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <div className="relative group">
              ...
              <img 
                src="Periwinkle.jpg" // Ganti dengan path foto Aisyah
                alt="Aisyah sZarifa"
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            >
              Hello, i am 
              <br />
              <span className="text-gradient">Aisyah Zarifa</span>
            </motion.h1>
            ...
            >
              Nama ku aisyah, aku siswi yang sedang dalam proses belajar mengembangkan
              kemampuan dalam bidang coding :D
            </motion.p>
